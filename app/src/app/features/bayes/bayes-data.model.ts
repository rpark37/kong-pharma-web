// Ported from the user's therapeutic-tests-bayes-theorem project (src/app/models/bayes-data.model.ts).
...
export const LAYOUT_NAMES = ['Everyone', 'Disease vs healthy', 'Test outcome grid', 'Positive tests only'] as const;
