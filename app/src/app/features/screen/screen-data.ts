...
export const SCREEN_COLUMNS: ColumnDef[] = [
  ...
  { key: 'well', label: 'WELL', width: 60, sortable: true, code: true },
  { key: 'target', label: 'TARGET', width: 84, sortable: true, code: true },
  { key: 'library', label: 'LIBRARY', width: 72, sortable: true, code: true },
  { key: 'site', label: 'SITE', width: 92, sortable: true, code: true },
